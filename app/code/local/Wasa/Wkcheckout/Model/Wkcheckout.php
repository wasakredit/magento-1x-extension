...
class Wasa_Wkcheckout_Model_Wkcheckout extends Wasa_Wkcheckout_Model_Meta
{
     ...
     * expected by _client_sdk->calculate_monthly_cost
     *
    ...
    public function calculateProductLeasingCost($products)
    {
      ...
      $response = $this->_shot_caller->call('calculate_monthly_cost', $payload);
      $leasingCosts = $response['monthly_costs'];
      return $leasingCosts;
    ...
    {
      $response = $this->_shot_caller->call('validate_financed_amount', $amount);
